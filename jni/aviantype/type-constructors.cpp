...
{
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::CallSiteType]));
  o->setTarget(t, target);
  o->setInvocation(t, invocation);
}
...
void initCompileRoots(Thread* t, GcCompileRoots* o, GcArray* callTable, GcTreeNode* methodTree, GcTreeNode* methodTreeSentinal, object objectPools, object staticTableArray, GcWordArray* virtualThunks, GcWordArray* dynamicThunks, GcMethod* receiveMethod, GcMethod* windMethod, GcMethod* rewindMethod)
{
  ...
  o->setDynamicThunks(t, dynamicThunks);
...
void initInvocation(Thread* t, GcInvocation* o, uint16_t bootstrap, int32_t index, GcClass* class_, GcSingleton* pool, GcMethod* template_, GcArray* bootstrapMethodTable, GcCallSite* site)
{
  ...
  o->setBootstrapMethodTable(t, bootstrapMethodTable);
  o->setSite(t, site);
}
...
{
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::LookupType]));
  o->setClass(t, class_);
  o->setModes(t, modes);
}
...
{
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::MethodHandleType]));
  o->setKind(t, kind);
  o->setLoader(t, loader);
  o->setMethod(t, method);
  o->setType(t, type);
...
{
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::MethodTypeType]));
  o->setLoader(t, loader);
  o->setSpec(t, spec);
  o->setParameters(t, parameters);
  o->setResult(t, result);
  o->setFootprint(t, footprint);
}
...
void initRoots(Thread* t, GcRoots* o, GcClassLoader* bootLoader, GcClassLoader* appLoader, GcHashMap* bootstrapClassMap, GcHashMap* packageMap, GcMethod* findLoadedClassMethod, GcMethod* loadClassMethod, GcHashMap* monitorMap, GcHashMap* stringMap, GcHashMap* byteArrayMap, GcHashMap* poolMap, GcVector* classRuntimeDataTable, GcVector* methodRuntimeDataTable, GcVector* jNIMethodTable, GcVector* jNIFieldTable, GcPair* shutdownHooks, GcThread* finalizerThread, GcFinalizer* objectsToFinalize, GcCleaner* objectsToClean, GcThrowable* nullPointerException, GcThrowable* arithmeticException, GcThrowable* arrayIndexOutOfBoundsException, GcThrowable* outOfMemoryError, GcThrowable* shutdownInProgress, GcFinder* virtualFileFinders, GcArray* virtualFiles, GcArray* arrayInterfaceTable, object threadTerminated, GcArray* invocations)
{
  ...
  o->setInvocations(t, invocations);
}
...
GcCallSite* GcCallSite::makeZeroed(Thread* t)
{
  GcCallSite* o = reinterpret_cast<GcCallSite*>(allocate(t, 12, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::CallSiteType]));
  return o;
}
...
GcCallSite* makeCallSite(Thread* t, GcMethodHandle* target, GcInvocation* invocation)
{
  ...
  GcCallSite* o = reinterpret_cast<GcCallSite*>(allocate(t, 12, true));
  initCallSite(t, o, target, invocation);
  return o;
}
...
{
  GcCompileRoots* o = reinterpret_cast<GcCompileRoots*>(allocate(t, 44, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::CompileRootsType]));
  return o;
}
...
GcCompileRoots* makeCompileRoots(Thread* t, GcArray* callTable, GcTreeNode* methodTree, GcTreeNode* methodTreeSentinal, object objectPools, object staticTableArray, GcWordArray* virtualThunks, GcWordArray* dynamicThunks, GcMethod* receiveMethod, GcMethod* windMethod, GcMethod* rewindMethod)
{
  ...
  PROTECT(t, dynamicThunks);
  PROTECT(t, receiveMethod);
  PROTECT(t, windMethod);
  PROTECT(t, rewindMethod);
  GcCompileRoots* o = reinterpret_cast<GcCompileRoots*>(allocate(t, 44, true));
  initCompileRoots(t, o, callTable, methodTree, methodTreeSentinal, objectPools, staticTableArray, virtualThunks, dynamicThunks, receiveMethod, windMethod, rewindMethod);
  return o;
}
...
{
  GcInvocation* o = reinterpret_cast<GcInvocation*>(allocate(t, 32, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::InvocationType]));
  return o;
}
...
GcInvocation* makeInvocation(Thread* t, uint16_t bootstrap, int32_t index, GcClass* class_, GcSingleton* pool, GcMethod* template_, GcArray* bootstrapMethodTable, GcCallSite* site)
{
  ...
  PROTECT(t, pool);
  PROTECT(t, template_);
  PROTECT(t, bootstrapMethodTable);
  PROTECT(t, site);
  GcInvocation* o = reinterpret_cast<GcInvocation*>(allocate(t, 32, true));
  initInvocation(t, o, bootstrap, index, class_, pool, template_, bootstrapMethodTable, site);
  return o;
}
...
GcLookup* GcLookup::makeZeroed(Thread* t)
{
  GcLookup* o = reinterpret_cast<GcLookup*>(allocate(t, 12, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::LookupType]));
  return o;
}
...
{
  PROTECT(t, class_);
  GcLookup* o = reinterpret_cast<GcLookup*>(allocate(t, 12, true));
  initLookup(t, o, class_, modes);
  return o;
}
...
GcMethodHandle* GcMethodHandle::makeZeroed(Thread* t)
{
  GcMethodHandle* o = reinterpret_cast<GcMethodHandle*>(allocate(t, 20, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::MethodHandleType]));
  return o;
}
...
GcMethodHandle* makeMethodHandle(Thread* t, uint32_t kind, GcClassLoader* loader, GcMethod* method, GcMethodType* type)
{
  ...
  PROTECT(t, method);
  PROTECT(t, type);
  GcMethodHandle* o = reinterpret_cast<GcMethodHandle*>(allocate(t, 20, true));
  initMethodHandle(t, o, kind, loader, method, type);
  return o;
}
...
GcMethodType* GcMethodType::makeZeroed(Thread* t)
{
  GcMethodType* o = reinterpret_cast<GcMethodType*>(allocate(t, 24, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::MethodTypeType]));
  return o;
}
...
GcMethodType* makeMethodType(Thread* t, GcClassLoader* loader, GcByteArray* spec, object parameters, object result, uint32_t footprint)
{
  PROTECT(t, loader);
  PROTECT(t, spec);
  PROTECT(t, parameters);
  PROTECT(t, result);
  GcMethodType* o = reinterpret_cast<GcMethodType*>(allocate(t, 24, true));
  initMethodType(t, o, loader, spec, parameters, result, footprint);
  return o;
}
...
{
  GcRoots* o = reinterpret_cast<GcRoots*>(allocate(t, 116, false));
  setObjectClass(t, reinterpret_cast<object>(o), reinterpret_cast<GcClass*>(reinterpret_cast<GcArray*>(t->m->types)->body()[Gc::RootsType]));
  return o;
}

...
const unsigned CallSiteTarget = 4;

#define HAVE_CallSiteTarget 1
#define HAVE_CallSiteTarget_Ljava_lang_invoke_MethodHandle_ 1

const unsigned CallSiteInvocation = 8;

#define HAVE_CallSiteInvocation 1
const unsigned CharValue = 4;

#define HAVE_CharValue 1
#define HAVE_CharValue_C 1
...
#define HAVE_CloneNotSupportedExceptionMessage_Ljava_lang_String_ 1

const unsigned CloneNotSupportedExceptionTrace = 8;

#define HAVE_CloneNotSupportedExceptionTrace 1
#define HAVE_CloneNotSupportedExceptionTrace_Ljava_lang_Object_ 1

const unsigned CloneNotSupportedExceptionCause = 12;

#define HAVE_CloneNotSupportedExceptionCause 1
#define HAVE_CloneNotSupportedExceptionCause_Ljava_lang_Throwable_ 1
...
const unsigned CompileRootsDynamicThunks = 28;

#define HAVE_CompileRootsDynamicThunks 1
const unsigned CompileRootsReceiveMethod = 32;

#define HAVE_CompileRootsReceiveMethod 1
const unsigned CompileRootsWindMethod = 36;

#define HAVE_CompileRootsWindMethod 1
const unsigned CompileRootsRewindMethod = 40;
...
#define HAVE_InterruptedExceptionMessage_Ljava_lang_String_ 1

const unsigned InterruptedExceptionTrace = 8;

#define HAVE_InterruptedExceptionTrace 1
#define HAVE_InterruptedExceptionTrace_Ljava_lang_Object_ 1

const unsigned InterruptedExceptionCause = 12;

#define HAVE_InterruptedExceptionCause 1
#define HAVE_InterruptedExceptionCause_Ljava_lang_Throwable_ 1
...
const unsigned InvocationBootstrapMethodTable = 24;

#define HAVE_InvocationBootstrapMethodTable 1
const unsigned InvocationSite = 28;
...
#define HAVE_LinkageErrorMessage_Ljava_lang_String_ 1

const unsigned LinkageErrorTrace = 8;

#define HAVE_LinkageErrorTrace 1
#define HAVE_LinkageErrorTrace_Ljava_lang_Object_ 1

const unsigned LinkageErrorCause = 12;

#define HAVE_LinkageErrorCause 1
#define HAVE_LinkageErrorCause_Ljava_lang_Throwable_ 1
...
const unsigned LookupClass = 4;

#define HAVE_LookupClass 1
#define HAVE_LookupClass_Lavian_VMClass_ 1

const unsigned LookupModes = 8;

#define HAVE_LookupModes 1
#define HAVE_LookupModes_I 1

const unsigned MethodVmFlags = 4;

#define HAVE_MethodVmFlags 1
#define HAVE_MethodVmFlags_B 1

const unsigned MethodReturnCode = 5;

#define HAVE_MethodReturnCode 1
#define HAVE_MethodReturnCode_B 1

const unsigned MethodParameterCount = 6;

#define HAVE_MethodParameterCount 1
#define HAVE_MethodParameterCount_B 1

const unsigned MethodParameterFootprint = 7;

#define HAVE_MethodParameterFootprint 1
#define HAVE_MethodParameterFootprint_B 1

const unsigned MethodFlags = 8;

#define HAVE_MethodFlags 1
#define HAVE_MethodFlags_S 1

const unsigned MethodOffset = 10;

#define HAVE_MethodOffset 1
#define HAVE_MethodOffset_S 1

const unsigned MethodNativeID = 12;

#define HAVE_MethodNativeID 1
#define HAVE_MethodNativeID_I 1

const unsigned MethodRuntimeDataIndex = 16;

#define HAVE_MethodRuntimeDataIndex 1
#define HAVE_MethodRuntimeDataIndex_I 1

const unsigned MethodName = 20;

#define HAVE_MethodName 1
#define HAVE_MethodName__B 1

const unsigned MethodSpec = 24;

#define HAVE_MethodSpec 1
#define HAVE_MethodSpec__B 1

const unsigned MethodAddendum = 28;

#define HAVE_MethodAddendum 1
#define HAVE_MethodAddendum_Lavian_MethodAddendum_ 1

const unsigned MethodClass = 32;

#define HAVE_MethodClass 1
#define HAVE_MethodClass_Lavian_VMClass_ 1

const unsigned MethodCode = 36;

#define HAVE_MethodCode 1
#define HAVE_MethodCode_Lavian_Code_ 1

const unsigned MethodAddendumPool = 4;

#define HAVE_MethodAddendumPool 1
#define HAVE_MethodAddendumPool_Lavian_Singleton_ 1

const unsigned MethodAddendumAnnotationTable = 8;

#define HAVE_MethodAddendumAnnotationTable 1
#define HAVE_MethodAddendumAnnotationTable_Ljava_lang_Object_ 1

const unsigned MethodAddendumSignature = 12;

#define HAVE_MethodAddendumSignature 1
#define HAVE_MethodAddendumSignature_Ljava_lang_Object_ 1

const unsigned MethodAddendumExceptionTable = 16;

#define HAVE_MethodAddendumExceptionTable 1
#define HAVE_MethodAddendumExceptionTable_Ljava_lang_Object_ 1

const unsigned MethodAddendumAnnotationDefault = 20;

#define HAVE_MethodAddendumAnnotationDefault 1
#define HAVE_MethodAddendumAnnotationDefault_Ljava_lang_Object_ 1

const unsigned MethodAddendumParameterAnnotationTable = 24;

#define HAVE_MethodAddendumParameterAnnotationTable 1
#define HAVE_MethodAddendumParameterAnnotationTable_Ljava_lang_Object_ 1

const unsigned MethodHandleKind = 4;

#define HAVE_MethodHandleKind 1
#define HAVE_MethodHandleKind_I 1

const unsigned MethodHandleLoader = 8;

#define HAVE_MethodHandleLoader 1
#define HAVE_MethodHandleLoader_Ljava_lang_ClassLoader_ 1

const unsigned MethodHandleMethod = 12;

#define HAVE_MethodHandleMethod 1
#define HAVE_MethodHandleMethod_Lavian_VMMethod_ 1

const unsigned MethodHandleType = 16;

#define HAVE_MethodHandleType 1
#define HAVE_MethodHandleType_Ljava_lang_invoke_MethodType_ 1

const unsigned MethodRuntimeDataNative = 4;

#define HAVE_MethodRuntimeDataNative 1
const unsigned MethodTypeLoader = 4;

#define HAVE_MethodTypeLoader 1
#define HAVE_MethodTypeLoader_Ljava_lang_ClassLoader_ 1

const unsigned MethodTypeSpec = 8;

#define HAVE_MethodTypeSpec 1
#define HAVE_MethodTypeSpec__B 1

const unsigned MethodTypeParameters = 12;

#define HAVE_MethodTypeParameters 1
#define HAVE_MethodTypeParameters_Ljava_util_List_ 1

const unsigned MethodTypeResult = 16;

#define HAVE_MethodTypeResult 1
#define HAVE_MethodTypeResult_Ljava_lang_invoke_MethodType_Result_ 1

const unsigned MethodTypeFootprint = 20;

#define HAVE_MethodTypeFootprint 1
#define HAVE_MethodTypeFootprint_I 1
...
#define HAVE_PhantomReferenceVmNext_Ljava_lang_Object_ 1

const unsigned PhantomReferenceTarget = 8;

#define HAVE_PhantomReferenceTarget 1
#define HAVE_PhantomReferenceTarget_Ljava_lang_Object_ 1

const unsigned PhantomReferenceQueue = 12;

#define HAVE_PhantomReferenceQueue 1
#define HAVE_PhantomReferenceQueue_Ljava_lang_ref_ReferenceQueue_ 1

const unsigned PhantomReferenceJNext = 16;

#define HAVE_PhantomReferenceJNext 1
#define HAVE_PhantomReferenceJNext_Ljava_lang_ref_Reference_ 1
...
#define HAVE_ReferenceQueueFront_Ljava_lang_ref_Reference_ 1
...
#define HAVE_ReflectiveOperationExceptionMessage_Ljava_lang_String_ 1

const unsigned ReflectiveOperationExceptionTrace = 8;

#define HAVE_ReflectiveOperationExceptionTrace 1
#define HAVE_ReflectiveOperationExceptionTrace_Ljava_lang_Object_ 1

const unsigned ReflectiveOperationExceptionCause = 12;

#define HAVE_ReflectiveOperationExceptionCause 1
#define HAVE_ReflectiveOperationExceptionCause_Ljava_lang_Throwable_ 1
...
#define HAVE_VirtualMachineErrorMessage_Ljava_lang_String_ 1

const unsigned VirtualMachineErrorTrace = 8;

#define HAVE_VirtualMachineErrorTrace 1
#define HAVE_VirtualMachineErrorTrace_Ljava_lang_Object_ 1

const unsigned VirtualMachineErrorCause = 12;

#define HAVE_VirtualMachineErrorCause 1
#define HAVE_VirtualMachineErrorCause_Ljava_lang_Throwable_ 1
...
#define HAVE_WeakReferenceVmNext_Ljava_lang_Object_ 1

const unsigned WeakReferenceTarget = 8;

#define HAVE_WeakReferenceTarget 1
#define HAVE_WeakReferenceTarget_Ljava_lang_Object_ 1

const unsigned WeakReferenceQueue = 12;

#define HAVE_WeakReferenceQueue 1
#define HAVE_WeakReferenceQueue_Ljava_lang_ref_ReferenceQueue_ 1

const unsigned WeakReferenceJNext = 16;

#define HAVE_WeakReferenceJNext 1
#define HAVE_WeakReferenceJNext_Ljava_lang_ref_Reference_ 1
...
const unsigned FixedSizeOfCallSite = 12;
...
const unsigned FixedSizeOfCompileRoots = 44;
...
const unsigned FixedSizeOfInvocation = 32;
...
const unsigned FixedSizeOfRoots = 116;
...
class GcCallSite: public GcObject {
 public:
  static const Gc::Type Type = Gc::CallSiteType;
  static const size_t FixedSize = FixedSizeOfCallSite;

  static GcCallSite* makeZeroed(Thread* t);
  void setTarget(Thread* t UNUSED, GcMethodHandle* value) { setField(t, this , CallSiteTarget, reinterpret_cast<object>(value)); }
  GcMethodHandle** targetPtr() { return &field_at<GcMethodHandle*>(CallSiteTarget); }
  GcMethodHandle* target() { return field_at<GcMethodHandle*>(CallSiteTarget); }
  void setInvocation(Thread* t UNUSED, GcInvocation* value) { setField(t, this , CallSiteInvocation, reinterpret_cast<object>(value)); }
  GcInvocation** invocationPtr() { return &field_at<GcInvocation*>(CallSiteInvocation); }
  GcInvocation* invocation() { return field_at<GcInvocation*>(CallSiteInvocation); }
};
...
class GcCompileRoots: public GcObject {
 public:
  ...
  void setDynamicThunks(Thread* t UNUSED, GcWordArray* value) { setField(t, this , CompileRootsDynamicThunks, reinterpret_cast<object>(value)); }
  GcWordArray** dynamicThunksPtr() { return &field_at<GcWordArray*>(CompileRootsDynamicThunks); }
  GcWordArray* dynamicThunks() { return field_at<GcWordArray*>(CompileRootsDynamicThunks); }
...
class GcInvocation: public GcObject {
 public:
  ...
  void setClass(Thread* t UNUSED, GcClass* value) { setField(t, this , InvocationClass, reinterpret_cast<object>(value)); }
  GcClass** class_Ptr() { return &field_at<GcClass*>(InvocationClass); }
  GcClass* class_() { return field_at<GcClass*>(InvocationClass); }
  void setPool(Thread* t UNUSED, GcSingleton* value) { setField(t, this , InvocationPool, reinterpret_cast<object>(value)); }
  GcSingleton** poolPtr() { return &field_at<GcSingleton*>(InvocationPool); }
  GcSingleton* pool() { return field_at<GcSingleton*>(InvocationPool); }
  void setTemplate(Thread* t UNUSED, GcMethod* value) { setField(t, this , InvocationTemplate, reinterpret_cast<object>(value)); }
  GcMethod** template_Ptr() { return &field_at<GcMethod*>(InvocationTemplate); }
  GcMethod* template_() { return field_at<GcMethod*>(InvocationTemplate); }
  void setBootstrapMethodTable(Thread* t UNUSED, GcArray* value) { setField(t, this , InvocationBootstrapMethodTable, reinterpret_cast<object>(value)); }
  GcArray** bootstrapMethodTablePtr() { return &field_at<GcArray*>(InvocationBootstrapMethodTable); }
  GcArray* bootstrapMethodTable() { return field_at<GcArray*>(InvocationBootstrapMethodTable); }
  void setSite(Thread* t UNUSED, GcCallSite* value) { setField(t, this , InvocationSite, reinterpret_cast<object>(value)); }
  GcCallSite** sitePtr() { return &field_at<GcCallSite*>(InvocationSite); }
  GcCallSite* site() { return field_at<GcCallSite*>(InvocationSite); }
};
...
class GcLookup: public GcObject {
 public:
  static const Gc::Type Type = Gc::LookupType;
  static const size_t FixedSize = FixedSizeOfLookup;

  static GcLookup* makeZeroed(Thread* t);
  void setClass(Thread* t UNUSED, GcClass* value) { setField(t, this , LookupClass, reinterpret_cast<object>(value)); }
  GcClass** class_Ptr() { return &field_at<GcClass*>(LookupClass); }
  GcClass* class_() { return field_at<GcClass*>(LookupClass); }
  void setModes(Thread* t UNUSED, uint32_t value) { field_at<uint32_t>(LookupModes) = value; }
  uint32_t* modesPtr() { return &field_at<uint32_t>(LookupModes); }
  uint32_t& modes() { return field_at<uint32_t>(LookupModes); }
};
...
class GcMethodHandle: public GcObject {
 public:
  static const Gc::Type Type = Gc::MethodHandleType;
  static const size_t FixedSize = FixedSizeOfMethodHandle;

  static GcMethodHandle* makeZeroed(Thread* t);
  void setKind(Thread* t UNUSED, uint32_t value) { field_at<uint32_t>(MethodHandleKind) = value; }
  uint32_t* kindPtr() { return &field_at<uint32_t>(MethodHandleKind); }
  uint32_t& kind() { return field_at<uint32_t>(MethodHandleKind); }
  void setLoader(Thread* t UNUSED, GcClassLoader* value) { setField(t, this , MethodHandleLoader, reinterpret_cast<object>(value)); }
  GcClassLoader** loaderPtr() { return &field_at<GcClassLoader*>(MethodHandleLoader); }
  GcClassLoader* loader() { return field_at<GcClassLoader*>(MethodHandleLoader); }
  void setMethod(Thread* t UNUSED, GcMethod* value) { setField(t, this , MethodHandleMethod, reinterpret_cast<object>(value)); }
  GcMethod** methodPtr() { return &field_at<GcMethod*>(MethodHandleMethod); }
  GcMethod* method() { return field_at<GcMethod*>(MethodHandleMethod); }
  void setType(Thread* t UNUSED, GcMethodType* value) { setField(t, this , MethodHandleType, reinterpret_cast<object>(value)); }
  GcMethodType** typePtr() { return &field_at<GcMethodType*>(MethodHandleType); }
  GcMethodType* type() { return field_at<GcMethodType*>(MethodHandleType); }
};
...
class GcMethodType: public GcObject {
 public:
  static const Gc::Type Type = Gc::MethodTypeType;
  static const size_t FixedSize = FixedSizeOfMethodType;

  static GcMethodType* makeZeroed(Thread* t);
  void setLoader(Thread* t UNUSED, GcClassLoader* value) { setField(t, this , MethodTypeLoader, reinterpret_cast<object>(value)); }
  GcClassLoader** loaderPtr() { return &field_at<GcClassLoader*>(MethodTypeLoader); }
  GcClassLoader* loader() { return field_at<GcClassLoader*>(MethodTypeLoader); }
  void setSpec(Thread* t UNUSED, GcByteArray* value) { setField(t, this , MethodTypeSpec, reinterpret_cast<object>(value)); }
  GcByteArray** specPtr() { return &field_at<GcByteArray*>(MethodTypeSpec); }
  GcByteArray* spec() { return field_at<GcByteArray*>(MethodTypeSpec); }
  void setParameters(Thread* t UNUSED, object value) { setField(t, this , MethodTypeParameters, reinterpret_cast<object>(value)); }
  object* parametersPtr() { return &field_at<object>(MethodTypeParameters); }
  object parameters() { return field_at<object>(MethodTypeParameters); }
  void setResult(Thread* t UNUSED, object value) { setField(t, this , MethodTypeResult, reinterpret_cast<object>(value)); }
  object* resultPtr() { return &field_at<object>(MethodTypeResult); }
  object result() { return field_at<object>(MethodTypeResult); }
  void setFootprint(Thread* t UNUSED, uint32_t value) { field_at<uint32_t>(MethodTypeFootprint) = value; }
  uint32_t* footprintPtr() { return &field_at<uint32_t>(MethodTypeFootprint); }
  uint32_t& footprint() { return field_at<uint32_t>(MethodTypeFootprint); }
};
...
class GcRoots: public GcObject {
 public:
  ...
  void setInvocations(Thread* t UNUSED, GcArray* value) { setField(t, this , RootsInvocations, reinterpret_cast<object>(value)); }
  GcArray** invocationsPtr() { return &field_at<GcArray*>(RootsInvocations); }
  GcArray* invocations() { return field_at<GcArray*>(RootsInvocations); }
};
...
void initCallSite(Thread* t, GcCallSite* o, GcMethodHandle* target, GcInvocation* invocation);
...
void initCompileRoots(Thread* t, GcCompileRoots* o, GcArray* callTable, GcTreeNode* methodTree, GcTreeNode* methodTreeSentinal, object objectPools, object staticTableArray, GcWordArray* virtualThunks, GcWordArray* dynamicThunks, GcMethod* receiveMethod, GcMethod* windMethod, GcMethod* rewindMethod);
...
void initInvocation(Thread* t, GcInvocation* o, uint16_t bootstrap, int32_t index, GcClass* class_, GcSingleton* pool, GcMethod* template_, GcArray* bootstrapMethodTable, GcCallSite* site);
...
void initLookup(Thread* t, GcLookup* o, GcClass* class_, uint32_t modes);
...
void initMethodHandle(Thread* t, GcMethodHandle* o, uint32_t kind, GcClassLoader* loader, GcMethod* method, GcMethodType* type);

void initMethodRuntimeData(Thread* t, GcMethodRuntimeData* o, GcNative* native);

void initMethodType(Thread* t, GcMethodType* o, GcClassLoader* loader, GcByteArray* spec, object parameters, object result, uint32_t footprint);
...
GcCallSite* makeCallSite(Thread* t, GcMethodHandle* target, GcInvocation* invocation);
...
GcCompileRoots* makeCompileRoots(Thread* t, GcArray* callTable, GcTreeNode* methodTree, GcTreeNode* methodTreeSentinal, object objectPools, object staticTableArray, GcWordArray* virtualThunks, GcWordArray* dynamicThunks, GcMethod* receiveMethod, GcMethod* windMethod, GcMethod* rewindMethod);
...
GcInvocation* makeInvocation(Thread* t, uint16_t bootstrap, int32_t index, GcClass* class_, GcSingleton* pool, GcMethod* template_, GcArray* bootstrapMethodTable, GcCallSite* site);
...
GcLookup* makeLookup(Thread* t, GcClass* class_, uint32_t modes);
...
GcMethodHandle* makeMethodHandle(Thread* t, uint32_t kind, GcClassLoader* loader, GcMethod* method, GcMethodType* type);

GcMethodRuntimeData* makeMethodRuntimeData(Thread* t, GcNative* native);

GcMethodType* makeMethodType(Thread* t, GcClassLoader* loader, GcByteArray* spec, object parameters, object result, uint32_t footprint);
